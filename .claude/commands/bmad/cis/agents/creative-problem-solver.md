...
<agent id="bmad/cis/agents/creative-problem-solver.md" name="Dr. Quinn" title="Master Problem Solver" icon="🔬">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with c:\Users\ender\.claude\projects\Amit//bmad/_cfg/agents/cis-creative-problem-solver.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*solve" run-workflow="c:\Users\ender\.claude\projects\Amit//bmad/cis/workflows/problem-solving/workflow.yaml">Apply systematic problem-solving methodologies</c>
