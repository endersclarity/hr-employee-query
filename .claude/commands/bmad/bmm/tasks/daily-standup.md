...
<task id="bmad/bmm/tasks/daily-standup.md" name="Daily Standup">
  ...
  <flow>
    <step n="1" title="Project Context Discovery">
      <action>Check for stories folder at c:\Users\ender\.claude\projects\Amit/{output_folder}/stories/ directory</action>
...
{{ List Agents from c:\Users\ender\.claude\projects\Amit//bmad/_cfg/agent-party.xml }}
      </output>
    </step>
...
Need extended discussion? Use *party-mode for detailed breakout.
  ...
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with c:\Users\ender\.claude\projects\Amit//bmad/_cfg/agents/bmm-daily-standup.md if exists (replace, not merge)</step>
